...
public class GeometryGetVector extends Script {
		...
		if (bExecution) {
			try {
				...
				if ((0 <= value1Index1) && (0 <= value2Index1) && (0 <= value1Index2) && (0 <= value2Index2)) {
					...
					Double	x = new Double(x2.doubleValue() - x1.doubleValue());
					Double	y = new Double(y2.doubleValue() - y1.doubleValue());
					Double	z = new Double(z2.doubleValue() - z1.doubleValue());
