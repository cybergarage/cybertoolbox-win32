...
public class GeometryGetDot extends Script {
		...
		if (bExecution) {
			try {
				...
				if ((0 <= value1Index1) && (0 <= value2Index1) && (0 <= value1Index2) && (0 <= value2Index2)) {
					...
					Double	dot = new Double(x1.doubleValue()*x2.doubleValue() + y1.doubleValue()*y2.doubleValue() + z1.doubleValue()*z2.doubleValue()); 
					
					valueOutString = valueOutString.valueOf(dot.toString());
				}
				else 
