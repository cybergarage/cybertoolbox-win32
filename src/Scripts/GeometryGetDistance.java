...
public class GeometryGetDistance extends Script {
		...
		if (bExecution) {
			try {
				...
				if ((0 <= value1Index1) && (0 <= value2Index1) && (0 <= value1Index2) && (0 <= value2Index2)) {
					...
					double x = x2.doubleValue() - x1.doubleValue();
					double y = y2.doubleValue() - y1.doubleValue();
					double z = z2.doubleValue() - z1.doubleValue();
					
					Double	mag = new Double(Math.sqrt(x*x + y*y + z*z));
