...
public class GeometryGetAngle extends Script {
		...
		if (bExecution) {
			try {
				...
				if ((0 <= value1Index1) && (0 <= value2Index1) && (0 <= value1Index2) && (0 <= value2Index2)) {
					...
					double mag1	= Math.sqrt(x1.doubleValue()*x1.doubleValue() + y1.doubleValue()*y1.doubleValue() + z1.doubleValue()*z1.doubleValue());		
					double mag2	= Math.sqrt(x2.doubleValue()*x2.doubleValue() + y2.doubleValue()*y2.doubleValue() + z2.doubleValue()*z2.doubleValue());
					double dot	= x1.doubleValue()*x2.doubleValue() + y1.doubleValue()*y2.doubleValue() + z1.doubleValue()*z2.doubleValue(); 
					
					double cosAngle = dot / (mag1 * mag2);
					
					Double angle = new Double(Math.acos(cosAngle));
					
					valueOutString = valueOutString.valueOf(angle.toString());
				}
				else 
